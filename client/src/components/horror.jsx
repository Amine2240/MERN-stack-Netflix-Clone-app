...
const Horror = ({
  ...
  useEffect(() => {
    addopinion(horrortable, sethorrortable);
  }, []);
                    ...
                    <div className=" w-full bg-gradient-to-t from-black to-transparent absolute hidden bottom-2 h-[150px]  group-hover:flex place-content-between items-end z-10  cursor-pointer ">
                      ...
                      <div className=" flex flex-col h-14 place-content-around mb-3 mr-2 z-30">
                        <FontAwesomeIcon
                          ...
                          onClick={(e) => {
                            handleButtonClick(e);
                            likedmovie(item, horrortable, sethorrortable);
                            {
                        ...
                        <FontAwesomeIcon
                          ...
                          icon={faThumbsUp}
                          onClick={(e) => {
                            opiniononclick1(item, horrortable, sethorrortable);
                            handleButtonClick(e);
                          }}
                        />
                        <FontAwesomeIcon
                          ...
                          icon={faThumbsDown}
                          onClick={(e) => {
                            opiniononclick2(item, horrortable, sethorrortable);
                            handleButtonClick(e);
                          }}
                        />
                      </div>
